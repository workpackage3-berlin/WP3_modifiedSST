...
expName = 'modified_stop_signal_task_v8_german_LSL'  # from the Builder filename that created this script
expInfo = {
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Juliette\\OneDrive\\Documents\\PhD\\Psychopy\\modifiedStopSignalTask\\modified_stop_signal_task_v8_german_LSL.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    screen_info = StreamInfo(name='PsychoPy_LSL_screen_events', type='Markers', channel_count=n_screen_channels, nominal_srate=0, channel_format='string', source_id='psy_marker')
    screen_outlet = StreamOutlet(screen_info)  # Broadcast the stream.
    screen_events = ['go_GO','go_GF','go_GC','go_STOP','STOP','CONTINUE']
    
    behavioral_info = StreamInfo(name='PsychoPy_LSL_behavioral_events', type='Markers', channel_count=n_beh_channels, nominal_srate=0, channel_format='string', source_id='psy_marker')
    behavioral_outlet = StreamOutlet(behavioral_info)  # Broadcast the stream.
    behavioral_events = ['resp','early_press']
