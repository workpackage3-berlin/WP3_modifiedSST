...
expName = 'mSST_v9_german_LSL'  # from the Builder filename that created this script
expInfo = {
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Juliette\\OneDrive\\Documents\\PhD\\Psychopy\\modifiedStopSignalTask\\mSST_v9_german_LSL.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    while continueRoutine:
        ...
        if key_resp_start_main_task.status == STARTED and not waitOnFlip:
            theseKeys = key_resp_start_main_task.getKeys(keyList=['s'], ignoreKeys=["escape"], waitRelease=False)
