...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    for thisBlock in blocks:
        ...
        for thisBreak_screen_loop in break_screen_loop:
            ...
            _key_resp_allKeys = []
            # keep track of which components have finished
            pulses_between_blocksComponents = [pulse_text, key_resp]
            ...
            if key_resp.keys in ['', [], None]:  # No response was made
                key_resp.keys = None
            break_screen_loop.addData('key_resp.keys',key_resp.keys)
            if key_resp.keys != None:  # we had a response
                break_screen_loop.addData('key_resp.rt', key_resp.rt)
                break_screen_loop.addData('key_resp.duration', key_resp.duration)
